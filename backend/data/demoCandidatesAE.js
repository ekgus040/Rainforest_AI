 ...
 * 후보지 A~E 시연용 데이터
 *
 * 지표명: fireDamageScore(산불피해도), landslideRiskScore(산사태위험도),
 * soilRunoffRiskScore(토사유출위험도), exposureScore(생활권노출도).
 * priorityScore/grade/gradeLabel은 ai/aiSupport.js의 normalizeCandidate가
 * 위 4개 지표로부터 계산하므로 여기서는 따로 정의하지 않는다.
 */
